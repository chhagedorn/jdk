...
import testlibrary_tests.ir_framework.examples.SkipTestExample;
 ...
 * test by passing the property flag {@code -DIgnoreSkip=true} or {@code -DFailOnSuccessfulSkip=true} (see
 * {@link SkipTestExample}). This can be useful when trying to quickly verify if a disabled test is still failing or not.
 *
 * <p>
