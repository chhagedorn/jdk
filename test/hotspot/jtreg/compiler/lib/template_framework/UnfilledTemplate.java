 ...
 * a {@link RenderableTemplate}).
 */
public sealed interface UnfilledTemplate extends TemplateBinding.Bindable {
    /**
     ...
     */
    record OneArgs<A>(String arg0Name, Function<A, TemplateBody> function)
            implements UnfilledTemplate {
        TemplateBody instantiate(A a) {
            return function.apply(a);
        }

        /**
         * Creates a {@link RenderableTemplate} which can be used as a {@link Token} inside
         * a {@link UnfilledTemplate} for nested code generation, and it can also be used with
         * {@link RenderableTemplate#render} to render the template to a {@link String}
         * directly.
         *
         * @param a The value for the (first) argument.
         * @return The template its argument applied.
         */
        public RenderableTemplate fillWith(A a) {
            return new RenderableTemplate.OneArgs<>(this, a);
        }
    }
     ...
     */
    record TwoArgs<A, B>(String arg0Name, String arg1Name, BiFunction<A, B, TemplateBody> function)
            implements UnfilledTemplate {
         ...
         */
        public RenderableTemplate fillWith(A a, B b) {
            return new RenderableTemplate.TwoArgs<>(this, a, b);
        }
    }
     ...
     */
    record ThreeArgs<A, B, C>(String arg0Name, String arg1Name, String arg2Name, TriFunction<A, B, C, TemplateBody> function)
            implements UnfilledTemplate {
         ...
         */
        public RenderableTemplate fillWith(A a, B b, C c) {
            return new RenderableTemplate.ThreeArgs<>(this, a, b, c);
        }
    }
}
