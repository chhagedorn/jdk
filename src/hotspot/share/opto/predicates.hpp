...
class TemplateAssertionExpression : public StackObj {
 ...
 private:
  OpaqueTemplateAssertionPredicateNode* clone(const TransformStrategyForOpaqueLoopNodes& transform_strategy, Node* new_ctrl, 
 ...
 public:
  ...
  OpaqueTemplateAssertionPredicateNode* clone_and_replace_init_and_stride(Node* new_control, Node* new_init, Node* new_stride,
                                                 PhaseIdealLoop* phase);
};
